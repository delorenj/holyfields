...
class CopilotToolPostV1Data(BaseModel):
    """Copilot post-tool-use payload."""

    model_config = ConfigDict(extra="forbid")

    hook: Literal['postToolUse'] = Field(..., description='Locked Copilot hook name for this schema.')
...
class CopilotToolPostV1(BaseModel):
    ...
    type: Literal['copilot.tool.post'] = Field(..., description='Locked event type for this schema.')
    ...
    data: CopilotToolPostV1Data = Field(..., description='Copilot post-tool-use payload.')

    EVENT_TYPE: ClassVar[str] = 'copilot.tool.post'
