...
class CopilotSessionStartedV1Data(BaseModel):
    """Copilot session-start payload."""

    model_config = ConfigDict(extra="forbid")

    hook: Literal['sessionStart'] = Field(..., description='Locked Copilot hook name for this schema.')
...
class CopilotSessionStartedV1(BaseModel):
    ...
    type: Literal['copilot.session.started'] = Field(..., description='Locked event type for this schema.')
    ...
    data: CopilotSessionStartedV1Data = Field(..., description='Copilot session-start payload.')

    EVENT_TYPE: ClassVar[str] = 'copilot.session.started'
