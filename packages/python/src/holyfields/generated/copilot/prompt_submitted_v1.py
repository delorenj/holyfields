...
class CopilotPromptSubmittedV1Data(BaseModel):
    """Copilot prompt-submission payload."""

    model_config = ConfigDict(extra="forbid")

    hook: Literal['userPromptSubmitted'] = Field(..., description='Locked Copilot hook name for this schema.')
...
class CopilotPromptSubmittedV1(BaseModel):
    ...
    type: Literal['copilot.prompt.submitted'] = Field(..., description='Locked event type for this schema.')
    ...
    data: CopilotPromptSubmittedV1Data = Field(..., description='Copilot prompt-submission payload.')

    EVENT_TYPE: ClassVar[str] = 'copilot.prompt.submitted'
