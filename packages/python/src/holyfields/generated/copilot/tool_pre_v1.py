...
class CopilotToolPreV1Data(BaseModel):
    """Copilot pre-tool-use payload."""

    model_config = ConfigDict(extra="forbid")

    hook: Literal['preToolUse'] = Field(..., description='Locked Copilot hook name for this schema.')
...
class CopilotToolPreV1(BaseModel):
    ...
    type: Literal['copilot.tool.pre'] = Field(..., description='Locked event type for this schema.')
    ...
    data: CopilotToolPreV1Data = Field(..., description='Copilot pre-tool-use payload.')

    EVENT_TYPE: ClassVar[str] = 'copilot.tool.pre'
