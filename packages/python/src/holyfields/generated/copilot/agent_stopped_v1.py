...
class CopilotAgentStoppedV1Data(BaseModel):
    """Copilot agent-stop payload."""

    model_config = ConfigDict(extra="forbid")

    hook: Literal['agentStop'] = Field(..., description='Locked Copilot hook name for this schema.')
...
class CopilotAgentStoppedV1(BaseModel):
    ...
    type: Literal['copilot.agent.stopped'] = Field(..., description='Locked event type for this schema.')
    ...
    data: CopilotAgentStoppedV1Data = Field(..., description='Copilot agent-stop payload.')

    EVENT_TYPE: ClassVar[str] = 'copilot.agent.stopped'
