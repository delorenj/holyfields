...
class CopilotSessionEndedV1Data(BaseModel):
    """Copilot session-end payload."""

    model_config = ConfigDict(extra="forbid")

    hook: Literal['sessionEnd'] = Field(..., description='Locked Copilot hook name for this schema.')
...
class CopilotSessionEndedV1(BaseModel):
    ...
    type: Literal['copilot.session.ended'] = Field(..., description='Locked event type for this schema.')
    ...
    data: CopilotSessionEndedV1Data = Field(..., description='Copilot session-end payload.')

    EVENT_TYPE: ClassVar[str] = 'copilot.session.ended'
