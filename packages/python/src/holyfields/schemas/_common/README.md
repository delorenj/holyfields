...
`allOf: [{ "$ref": "..." }]`. The Python generator inlines referenced parent
fields into child models. The TypeScript package also emits common Zod schemas
for consumers that need direct access to shared base contracts.
...
See the metarepo audit in
`33GOD/docs/architecture/holyfields-cloudevents-audit-2026-04-24.md` and
ADR-0001 + ADR-0002 for the full reasoning.
